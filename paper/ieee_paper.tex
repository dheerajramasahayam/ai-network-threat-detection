...
\item Deployment-oriented analysis through latency-under-load, real-time streaming evaluation, explainability-by-ablation, and a production deployment architecture tied to Kafka-style flow ingestion and SIEM/SOC handoff.
\end{itemize}
